    ...
    },
    {
      ...
      tasks: [
        ...
        // Period task: Mon-Fri sprint
        {
          ...
          completed: false,
          dueDate: '2026-05-05',
          dueEndDate: '2026-05-09',
        },
        // Overlapping period task: Wed-Fri (to demonstrate multi-period overlap)
        {
          id: 't_period2',
          title: 'Design Review Sessions',
          tag: 'REVIEW',
          tagType: 'review' as TagType,
          priority: 'MED' as Priority,
          hasReminder: false,
          completed: false,
          dueDate: '2026-05-07',
          dueEndDate: '2026-05-11',
        },
      ],
    },
    {
